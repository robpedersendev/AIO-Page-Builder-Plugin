...
**Knowledge base:** [Template system overview](../kb/templates/template-system-overview.md); [KB index](../kb/index.md); template workflows in [FILE_MAP.md](../kb/FILE_MAP.md) §7.
