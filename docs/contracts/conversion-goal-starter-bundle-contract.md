...
- **Combined subtype+goal overlays:** For exceptional (subtype, goal) pairs, optional joint bundle overlays are defined by [subtype-goal-starter-bundle-contract.md](subtype-goal-starter-bundle-contract.md) (Prompt 551). Goal overlays remain authoritative; combined overlays are bounded, admission-gated, and applied after goal overlays where allowed.
