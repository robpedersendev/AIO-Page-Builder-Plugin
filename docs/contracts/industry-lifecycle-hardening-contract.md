...
- **Documentation**: What is removed vs preserved for industry must be documented in this contract and in PORTABILITY_AND_UNINSTALL (industry subsection). Uninstall must not silently destroy user data contrary to policy.
