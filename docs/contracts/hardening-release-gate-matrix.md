...
| 2 | Accessibility | Admin UI passes agreed a11y checklist or audit; no critical a11y defects open. Template library semantic/accessibility audit (Prompt 186, template-library-accessibility-audit-report.md) supplies machine-checkable evidence for SEMANTIC/CTA and §56.6; manual markup review still required for rendered output. | QA / a11y owner |
