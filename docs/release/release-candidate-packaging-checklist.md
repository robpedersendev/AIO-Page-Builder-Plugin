...
*Complete this checklist for each release candidate. Sign off only when all required checks pass. Do not ship with failures in §1, §2 (required files/metadata), or §3 (exclusions).*
