...
| `aio-page-builder-global-style-tokens` | Global Style Tokens | Domain: Styling | `aio_manage_settings` | Edit global design token values (token spec–driven); save via Global_Style_Settings_Repository; reset to defaults; no raw CSS (Prompt 247) | Implemented |
| `aio-page-builder-global-component-overrides` | Global Component Overrides | Domain: Styling | `aio_manage_settings` | Edit approved component override keys (component spec–driven); save via repository; reset overrides; no arbitrary selectors/CSS (Prompt 248) | Implemented |
