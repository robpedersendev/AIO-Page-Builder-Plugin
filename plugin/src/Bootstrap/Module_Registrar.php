...
final class Module_Registrar {
	 ...
	 * ACF_Debug_Provider registers acf_local_json_mirror_service and acf_field_group_debug_exporter for debug export and environment comparison (Prompt 224); registry remains source of truth.
