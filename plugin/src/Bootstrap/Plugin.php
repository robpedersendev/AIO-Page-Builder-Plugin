...
require_once $bootstrap_dir . '/../Infrastructure/Container/Providers/Dashboard_Provider.php';
...
require_once $bootstrap_dir . '/../Domain/Registries/PageTemplate/ExpansionPack/Page_Template_And_Composition_Expansion_Pack_Definitions.php';
...
require_once $bootstrap_dir . '/../Domain/Registries/PageTemplate/TopLevelEducationalResourceAuthorityBatch/Top_Level_Educational_Resource_Authority_Page_Template_Definitions.php';
require_once $bootstrap_dir . '/../Domain/Registries/PageTemplate/TopLevelEducationalResourceAuthorityBatch/Top_Level_Educational_Resource_Authority_Page_Template_Seeder.php';
require_once $bootstrap_dir . '/../Domain/Registries/PageTemplate/TopLevelVariantExpansionBatch/Top_Level_Variant_Expansion_Page_Template_Definitions.php';
require_once $bootstrap_dir . '/../Domain/Registries/PageTemplate/TopLevelVariantExpansionBatch/Top_Level_Variant_Expansion_Page_Template_Seeder.php';
...
require_once $bootstrap_dir . '/../Domain/Registries/PageTemplate/HubNestedHubVariantExpansionBatch/Hub_Nested_Hub_Variant_Expansion_Page_Template_Definitions.php';
require_once $bootstrap_dir . '/../Domain/Registries/PageTemplate/HubNestedHubVariantExpansionBatch/Hub_Nested_Hub_Variant_Expansion_Page_Template_Seeder.php';
require_once $bootstrap_dir . '/../Domain/Registries/PageTemplate/ChildDetailBatch/Child_Detail_Page_Template_Definitions.php';
require_once $bootstrap_dir . '/../Domain/Registries/PageTemplate/ChildDetailBatch/Child_Detail_Page_Template_Seeder.php';
require_once $bootstrap_dir . '/../Domain/Registries/PageTemplate/ChildDetailProductBatch/Child_Detail_Product_Page_Template_Definitions.php';
