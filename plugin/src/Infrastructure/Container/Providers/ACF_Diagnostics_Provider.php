...
/**
 * Registers ACF diagnostics service and fixture builder for admin/QA inspection.
 * Depends on ACF blueprint, registration, assignment, and compatibility providers.
 */
