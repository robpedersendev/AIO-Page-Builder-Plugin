...
final class ACF_Assignment_Provider implements Service_Provider_Interface {
	...
	public function register( Service_Container $container ): void {
		$container->register( 'field_group_derivation_service', function () use ( $container ): Field_Group_Derivation_Service {
		...
		$container->register( 'page_field_group_assignment_service', function () use ( $container ): Page_Field_Group_Assignment_Service {
