...
final class ACF_Compatibility_Provider implements Service_Provider_Interface {
	...
	public function register( Service_Container $container ): void {
		$container->register( 'field_assignment_compatibility_service', function () use ( $container ): Field_Assignment_Compatibility_Service {
		...
		$container->register( 'field_cleanup_advisor', function () use ( $container ): Field_Cleanup_Advisor {
