...
final class Registries_Provider implements Service_Provider_Interface {
	...
	public function register( Service_Container $container ): void {
		$container->register(
			'section_definition_normalizer',
			function (): Section_Definition_Normalizer {
				return new Section_Definition_Normalizer();
			}
		);
		$container->register(
			'section_validator',
			function () use ( $container ): Section_Validator {
		...
		$container->register(
			'registry_deprecation_service',
			function () use ( $container ): Registry_Deprecation_Service {
		...
		$container->register(
			...
			function (): Template_Versioning_Service {
				return new Template_Versioning_Service();
			}
		);
		$container->register(
			'template_deprecation_service',
			function () use ( $container ): Template_Deprecation_Service {
				return new Template_Deprecation_Service( $container->get( 'registry_deprecation_service' ) );
			}
		);
		$container->register(
			'large_library_query_service',
			function () use ( $container ): Large_Library_Query_Service {
		...
		$container->register(
			'section_registry_service',
			function () use ( $container ): Section_Registry_Service {
		...
		$container->register(
			'page_template_normalizer',
			function (): Page_Template_Normalizer {
				return new Page_Template_Normalizer();
			}
		);
		$container->register(
			'page_template_validator',
			function () use ( $container ): Page_Template_Validator {
		...
		$container->register(
			'page_template_registry_service',
			function () use ( $container ): Page_Template_Registry_Service {
		...
		$container->register(
			'registry_integrity_validator',
			function () use ( $container ): Registry_Integrity_Validator {
		...
		$container->register(
			...
			function () use ( $container ): Composition_Validator {
		...
		$container->register(
			'large_composition_validator',
			function () use ( $container ): Large_Composition_Validator {
		...
		$container->register(
			'composition_registry_service',
			function () use ( $container ): Composition_Registry_Service {
		...
		$container->register(
			'composition_duplicator',
			function () use ( $container ): Composition_Duplicator {
				return new Composition_Duplicator( $container->get( 'composition_registry_service' ) );
			}
		);
		$container->register(
			'version_snapshot_service',
			function () use ( $container ): Version_Snapshot_Service {
		...
		$container->register(
			'registry_export_serializer',
			function () use ( $container ): Registry_Export_Serializer {
		...
		$container->register(
			'template_library_compliance_service',
			function () use ( $container ): Template_Library_Compliance_Service {
		...
		$container->register(
			'template_accessibility_audit_service',
			function () use ( $container ): Template_Accessibility_Audit_Service {
		...
		$container->register(
			'animation_qa_service',
			function () use ( $container ): Animation_QA_Service {
		...
		$container->register(
			'template_compare_state_builder',
			function () use ( $container ): Template_Compare_State_Builder {
		...
		$container->register(
			...
			function (): Preview_Cache_Service {
				return new Preview_Cache_Service();
			}
		);
		$container->register(
			'section_inventory_appendix_generator',
			function () use ( $container ): Section_Inventory_Appendix_Generator {
				return new Section_Inventory_Appendix_Generator( $container->get( 'section_template_repository' ) );
			}
		);
		$container->register(
			'page_template_inventory_appendix_generator',
			function () use ( $container ): Page_Template_Inventory_Appendix_Generator {
				return new Page_Template_Inventory_Appendix_Generator( $container->get( 'page_template_repository' ) );
			}
		);
		$container->register(
			'template_recommendation_context_builder',
			function () use ( $container ): Template_Recommendation_Context_Builder {
