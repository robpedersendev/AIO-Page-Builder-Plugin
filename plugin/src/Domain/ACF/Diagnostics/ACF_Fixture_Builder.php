...
final class ACF_Fixture_Builder {
	...
	private static function build_valid_scenario(): array {
		...
		$template = array(
			...
			'ordered_sections' => array(
				array(
					Page_Template_Schema::SECTION_ITEM_KEY => 'st_fixture_hero',
		...
		return array(
			...
			'assignment_rows'      => array(
				array(
					...
					'source_ref' => '1001',
					'target_ref' => 'pt_fixture_landing',
				),
				array(
					'map_type'   => 'page_field_group',
					'source_ref' => '1001',
					'target_ref' => 'group_aio_st_fixture_hero',
				),
			),
		);
	}
		...
		return array(
			...
			'assignment_rows'      => array(
				array(
					'map_type'   => 'page_template',
					'source_ref' => '1002',
					'target_ref' => 'pt_fixture_updated',
				),
				array(
					'map_type'   => 'page_field_group',
					'source_ref' => '1002',
					'target_ref' => 'group_aio_st_fixture_old',
				),
			),
		);
	}
	...
	private static function build_deprecated_scenario(): array {
		$section = array(
			...
			'deprecation'                      => array(
				'deprecated' => true,
				'reason'     => 'Replaced by st_fixture_hero.',
			),
			'field_blueprint'                  => array(
		...
		return array(
			...
			'assignment_rows'      => array(
				array(
					'map_type'   => 'page_field_group',
					'source_ref' => '1003',
					'target_ref' => 'group_aio_st_fixture_deprecated',
				),
			),
		);
	}
