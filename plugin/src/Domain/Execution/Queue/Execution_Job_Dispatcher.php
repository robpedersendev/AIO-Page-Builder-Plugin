...
/**
 * Queue job creation and dispatch through the single-action executor.
 */
final class Execution_Job_Dispatcher {
	...
	public function __construct( Job_Queue_Repository_Interface $job_queue_repository, Single_Action_Executor $single_action_executor ) {
