<?php
/**
 * Seeds the product/catalog child/detail page template batch (spec §13, §14.3, §16, §17.7, Prompt 161).
 * Run after section library and other page template batches so section keys exist.
 *
...
/**
 * One-way seed: writes product/catalog child/detail page templates to the page template repository.
 */
final class Child_Detail_Product_Page_Template_Seeder {

	/**
	 * Seeds all product/catalog child/detail page template definitions.
	 *
	...
	public static function run( Page_Template_Repository $page_repo ): array {
		...
		foreach ( Child_Detail_Product_Page_Template_Definitions::all_definitions() as $definition ) {
