<?php
/**
 * Seeds the top-level marketing page template batch (spec §13, §14, §16, Prompt 155).
...
/**
 * One-way seed: writes top-level marketing page templates to the page template repository.
 */
final class Top_Level_Marketing_Page_Template_Seeder {

	/**
	 * Seeds all top-level marketing page template definitions.
	 *
