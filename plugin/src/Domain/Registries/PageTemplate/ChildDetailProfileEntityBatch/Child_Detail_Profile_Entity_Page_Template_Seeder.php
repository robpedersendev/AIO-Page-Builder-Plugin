<?php
/**
 * Seeds the directory/profile/entity/resource child/detail page template batch (spec §13, §14.3, §16, §17.7, Prompt 162).
...
/**
 * One-way seed: writes directory/profile/entity/resource child/detail page templates to the page template repository.
 */
final class Child_Detail_Profile_Entity_Page_Template_Seeder {
	...
	public static function run( Page_Template_Repository $page_repo ): array {
		...
		foreach ( Child_Detail_Profile_Entity_Page_Template_Definitions::all_definitions() as $definition ) {
