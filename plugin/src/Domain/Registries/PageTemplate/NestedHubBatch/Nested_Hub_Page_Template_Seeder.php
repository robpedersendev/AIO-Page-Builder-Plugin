<?php
/**
 * Seeds the nested hub page template batch (spec §13, §14.3, §16, §17.7, Prompt 159).
 * Run after section library and hub batches (PT-03, PT-04) so section keys exist.
 *
...
/**
 * One-way seed: writes nested hub page templates to the page template repository.
 */
final class Nested_Hub_Page_Template_Seeder {

	/**
	 * Seeds all nested hub page template definitions.
	 *
	...
	public static function run( Page_Template_Repository $page_repo ): array {
		...
		foreach ( Nested_Hub_Page_Template_Definitions::all_definitions() as $definition ) {
