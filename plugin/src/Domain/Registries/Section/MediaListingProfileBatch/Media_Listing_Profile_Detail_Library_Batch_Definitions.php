...
final class Media_Listing_Profile_Detail_Library_Batch_Definitions {
	...
	public static function mlp_card_grid_01(): array {
		...
		return self::mlp_definition(
			...
			array(
				'short_label'         => 'Card grid',
				'suggested_use_cases' => array( 'Directory hub', 'Product grid', 'Service cards' ),
			)
		);
	}
	...
	public static function mlp_listing_01(): array {
		...
		return self::mlp_definition(
			...
			array(
				'short_label'         => 'Listing',
				'suggested_use_cases' => array( 'Directory', 'Resource list', 'Hub' ),
			)
		);
	}
	...
	public static function mlp_profile_summary_01(): array {
		...
		return self::mlp_definition(
			...
			array(
				'short_label'         => 'Profile summary',
				'suggested_use_cases' => array( 'Team detail', 'Author', 'About' ),
			)
		);
	}
	...
	public static function mlp_place_highlight_01(): array {
		...
		return self::mlp_definition(
			...
			array(
				'short_label'         => 'Place highlight',
				'suggested_use_cases' => array( 'Location page', 'Directory', 'Venues' ),
			)
		);
	}
	...
	public static function mlp_recommendation_band_01(): array {
		...
		return self::mlp_definition(
			...
			array(
				...
				'suggested_use_cases' => array( 'Detail page', 'Hub', 'Related' ),
			)
		);
	}
	...
	public static function mlp_media_band_01(): array {
		...
		return self::mlp_definition(
			...
			array(
				'short_label'         => 'Media band',
				'suggested_use_cases' => array( 'Product', 'Service', 'Media' ),
			)
		);
	}
	...
	public static function mlp_detail_spec_01(): array {
		...
		return self::mlp_definition(
			...
			array(
				'short_label'         => 'Detail spec',
				'suggested_use_cases' => array( 'Product detail', 'Service detail', 'Spec table' ),
			)
		);
	}
		...
		$fields = array(
			...
			array(
				...
				'sub_fields' => array(
					...
					array(
						'key'      => 'field_mlp_cc_features',
						'name'     => 'features',
						'label'    => 'Features (e.g. one per line)',
						'type'     => 'textarea',
						'required' => false,
					),
					array(
						'key'      => 'field_mlp_cc_link',
						'name'     => 'link',
						'label'    => 'Link',
						'type'     => 'link',
						'required' => false,
	...
	public static function mlp_related_content_01(): array {
		...
		return self::mlp_definition(
			...
			array(
				'short_label'         => 'Related content',
				'suggested_use_cases' => array( 'Detail page', 'Blog', 'Hub' ),
			)
		);
	}
	...
	public static function mlp_location_info_01(): array {
		...
		$fields = array(
			...
			array(
				'key'      => 'field_mlp_li_hours',
				'name'     => 'hours',
				'label'    => 'Hours or availability',
				'type'     => 'text',
				'required' => false,
			),
			array(
				'key'      => 'field_mlp_li_contact',
				'name'     => 'contact_label',
				'label'    => 'Contact label or phone',
				'type'     => 'text',
				'required' => false,
			),
		);
	...
	public static function mlp_directory_entry_01(): array {
		...
		$fields = array(
			...
			array(
				'key'      => 'field_mlp_de_meta',
				'name'     => 'meta_label',
				'label'    => 'Meta (e.g. category or type)',
				'type'     => 'text',
				'required' => false,
			),
			array(
				'key'      => 'field_mlp_de_image',
				'name'     => 'image',
				'label'    => 'Image',
				'type'     => 'image',
				'required' => false,
		...
		return self::mlp_definition(
			...
			array(
				'short_label'         => 'Directory entry',
				'suggested_use_cases' => array( 'Directory detail', 'Listing card', 'Hub' ),
			)
		);
	}
	...
	public static function mlp_team_grid_01(): array {
		...
		return self::mlp_definition(
			...
			array(
				'short_label'         => 'Team grid',
				'suggested_use_cases' => array( 'Team page', 'About', 'Staff' ),
			)
		);
	}
	...
	public static function mlp_product_cards_01(): array {
		...
		return self::mlp_definition(
			...
			array(
				'short_label'         => 'Product cards',
				'suggested_use_cases' => array( 'Product hub', 'Service list', 'Offering grid' ),
			)
		);
	}
}
