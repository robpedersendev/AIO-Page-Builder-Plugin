...
final class Trust_Proof_Library_Batch_Definitions {
	...
	public static function tp_testimonial_01(): array {
		...
		$fields = array(
			array(
				'key'          => 'field_tp_headline',
				'name'         => 'headline',
				'label'        => 'Headline',
				'type'         => 'text',
				'required'     => false,
				'instructions' => 'Optional section headline.',
			),
			array(
		...
		return self::proof_definition(
			...
			array(
				...
				'testimonials' => array(
					array(
						'quote'  => 'Synthetic sample quote for preview.',
						'name'   => 'Preview User',
						'role'   => 'Role',
						'avatar' => array(),
					),
			...
			array(
				'short_label'         => 'Testimonials',
				'suggested_use_cases' => array( 'Service page', 'Product page', 'Landing proof' ),
			)
		);
	}
	...
	public static function tp_testimonial_02(): array {
		...
		$fields = array(
			...
			array(
				'key'          => 'field_tp2_attribution',
				'name'         => 'attribution',
				'label'        => 'Attribution',
				'type'         => 'text',
				'required'     => false,
				'instructions' => 'e.g. Name, Title',
			),
		);
		return self::proof_definition(
			$key,
			...
			$fields,
			array(
				'quote'       => 'Synthetic quote for preview.',
				'attribution' => 'Preview Name, Title',
			),
			array(
				'short_label'         => 'Single quote',
				'suggested_use_cases' => array( 'Editorial', 'Authority proof', 'Highlight' ),
			)
		);
	}
	...
	public static function tp_review_01(): array {
		...
		return self::proof_definition(
			...
			array(
				...
				'summary'      => 'Synthetic summary for preview.',
			),
			array(
				'short_label'         => 'Review summary',
				'suggested_use_cases' => array( 'Product page', 'Service page', 'Directory entry' ),
			)
		);
	}
	...
	public static function tp_credential_01(): array {
		...
		return self::proof_definition(
			...
			array(
				'short_label'         => 'Credentials',
				'suggested_use_cases' => array( 'About', 'Service page', 'Trust block' ),
			)
		);
	}
	...
	public static function tp_credential_02(): array {
		...
		return self::proof_definition(
			...
			array(
				'headline' => 'Trusted by',
				'items'    => array( array( 'label' => 'Cert A' ), array( 'label' => 'Cert B' ) ),
			),
			array(
				'short_label'         => 'Credential strip',
				'suggested_use_cases' => array( 'Footer strip', 'Compact proof', 'Header band' ),
			)
		);
	}
	...
	public static function tp_guarantee_01(): array {
		...
		return self::proof_definition(
			...
			array(
				...
				'guarantee_text' => 'Synthetic guarantee text for preview only.',
				'badge_text'     => '',
			),
			array(
				'short_label'         => 'Guarantee',
				'suggested_use_cases' => array( 'Product page', 'Service page', 'Reassurance' ),
			)
		);
	}
	...
	public static function tp_case_teaser_01(): array {
		...
		$fields = array(
			...
			array(
				'key'      => 'field_tp_case_link',
				'name'     => 'link',
				'label'    => 'Link to full case study',
				'type'     => 'link',
				'required' => false,
			),
		);
		return self::proof_definition(
			...
			$fields,
			array(
				'headline'    => 'Case study preview',
				'outcome'     => 'Synthetic outcome.',
				'client_name' => 'Preview Client',
				'link'        => array(),
			),
			array(
				'short_label'         => 'Case teaser',
				'cta_classification'  => 'navigation_cta',
				'suggested_use_cases' => array( 'Service page', 'Offering page', 'Proof block' ),
			)
		);
	}
	...
	public static function tp_outcome_01(): array {
		...
		return self::proof_definition(
			...
			array(
				'short_label'         => 'Outcome stats',
				'suggested_use_cases' => array( 'Landing page', 'Service page', 'Proof metrics' ),
			)
		);
	}
	...
	public static function tp_badge_01(): array {
		...
		return self::proof_definition(
			...
			array(
				'short_label'         => 'Badges',
				'suggested_use_cases' => array( 'About', 'Service page', 'Trust band' ),
			)
		);
	}
	...
	public static function tp_client_logo_01(): array {
		...
		return self::proof_definition(
			...
			array(
				'short_label'         => 'Logo band',
				'suggested_use_cases' => array( 'Homepage', 'Service page', 'Partners' ),
			)
		);
	}
	...
	public static function tp_authority_01(): array {
		...
		return self::proof_definition(
			...
			$fields,
			array(
				'headline'   => 'Why we are trusted',
				'highlights' => array(
					array(
						'title'         => 'Expertise',
						'quote_or_fact' => 'Synthetic fact.',
					),
				),
			),
			array(
				'short_label'         => 'Authority',
				'suggested_use_cases' => array( 'About', 'Service page', 'Credibility' ),
			)
		);
	}
	...
	public static function tp_reassurance_01(): array {
		...
		return self::proof_definition(
			...
			array(
				...
				'points'   => array( array( 'text' => 'Synthetic point one' ), array( 'text' => 'Synthetic point two' ) ),
			),
			array(
				'short_label'         => 'Reassurance',
				'suggested_use_cases' => array( 'Product page', 'Service page', 'Checkout support' ),
			)
		);
	}
	...
	public static function tp_faq_microproof_01(): array {
		...
		$fields = array(
			...
			array(
				...
				'sub_fields' => array(
					...
					array(
						'key'      => 'field_tp_faq_stat',
						'name'     => 'proof_stat',
						'label'    => 'Optional proof stat',
						'type'     => 'text',
						'required' => false,
					),
				),
		...
		return self::proof_definition(
			...
			array(
				'short_label'         => 'FAQ proof',
				'suggested_use_cases' => array( 'Service page', 'Product page', 'Trust FAQ' ),
			)
		);
	}
	...
	public static function tp_partner_01(): array {
		...
		return self::proof_definition(
			...
			array(
				'short_label'         => 'Partners',
				'suggested_use_cases' => array( 'About', 'Channel page', 'Ecosystem' ),
			)
		);
	}
	...
	public static function tp_rating_01(): array {
		...
		return self::proof_definition(
			...
			array(
				'rating_value' => 4.5,
				'rating_label' => 'out of 5',
			),
			array(
				'short_label'         => 'Rating',
				'suggested_use_cases' => array( 'Product', 'Service', 'Directory' ),
			)
		);
	}
	...
	public static function tp_quote_01(): array {
		...
		return self::proof_definition(
			...
			array(
				'short_label'         => 'Pull quote',
				'suggested_use_cases' => array( 'Article', 'Resource', 'Authority' ),
			)
		);
	}
	...
	public static function tp_trust_band_01(): array {
		...
		return self::proof_definition(
			...
			array(
				...
				'trust_points' => array( array( 'text' => 'Secure' ), array( 'text' => 'Verified' ) ),
			),
			array(
				'short_label'         => 'Trust band',
				'suggested_use_cases' => array( 'Footer', 'Checkout', 'Landing' ),
			)
		);
	}
}
