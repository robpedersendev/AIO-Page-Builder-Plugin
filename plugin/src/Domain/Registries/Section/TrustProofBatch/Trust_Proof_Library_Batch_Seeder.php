<?php
/**
 * Seeds the trust/proof library batch (SEC-02) into the section template registry (spec §12, Prompt 148).
...
/**
 * One-way seed: writes trust/proof batch section definitions to the section repository.
 */
final class Trust_Proof_Library_Batch_Seeder {

	/**
	 * Seeds all trust/proof batch section definitions.
	 *
