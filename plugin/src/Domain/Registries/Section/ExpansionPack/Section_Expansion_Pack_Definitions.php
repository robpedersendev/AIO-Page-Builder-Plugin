...
final class Section_Expansion_Pack_Definitions {
	...
	public static function stats_highlights_definition(): array {
		...
		return array(
			...
			Section_Schema::FIELD_VARIANTS               => array(
				'default' => array( 'label' => 'Default', 'description' => 'Horizontal layout of stat items.' ),
				'compact' => array( 'label' => 'Compact', 'description' => 'Tighter spacing for dense layouts.', 'css_modifiers' => array( 'aio-s-st_stats_highlights--compact' ) ),
			),
	...
	public static function cta_conversion_definition(): array {
		...
		return array(
			...
			Section_Schema::FIELD_DEFAULT_VARIANT         => 'default',
			Section_Schema::FIELD_VARIANTS               => array(
				'default' => array( 'label' => 'Default', 'description' => 'Centered CTA block.' ),
				'minimal' => array( 'label' => 'Minimal', 'description' => 'Reduced emphasis, inline-style.', 'css_modifiers' => array( 'aio-s-st_cta_conversion--minimal' ) ),
			),
			Section_Schema::FIELD_COMPATIBILITY           => array(
				'may_precede'          => array(),
	...
	public static function faq_definition(): array {
		...
		return array(
			...
			Section_Schema::FIELD_DEFAULT_VARIANT         => 'default',
			Section_Schema::FIELD_VARIANTS               => array(
				'default'   => array( 'label' => 'Default', 'description' => 'List or accordion of Q&A pairs.' ),
				'accordion' => array( 'label' => 'Accordion', 'description' => 'Collapsible disclosure pattern.', 'css_modifiers' => array( 'aio-s-st_faq--accordion' ) ),
			),
			Section_Schema::FIELD_COMPATIBILITY           => array(
				'may_precede'          => array(),
