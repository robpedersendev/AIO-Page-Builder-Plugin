...
final class CTA_Super_Library_Batch_Definitions {
	...
	private static function standard_cta_fields( string $prefix ): array {
		return array(
			...
			array(
				'key'      => 'field_' . $prefix . '_primary_label',
			...
			array(
				'key'      => 'field_' . $prefix . '_primary_link',
			...
			array(
				'key'      => 'field_' . $prefix . '_secondary_label',
			...
			array(
				'key'      => 'field_' . $prefix . '_secondary_link',
			...
			array(
				'key'      => 'field_' . $prefix . '_trust_line',
				'name'     => 'trust_line',
				'label'    => 'Trust or proof line',
				'type'     => 'text',
				'required' => false,
			),
		);
	...
	public static function cta_consultation_01(): array {
		...
		return self::cta_definition(
			...
			array(
				...
				'body'                 => 'Discuss your needs with our team.',
				'primary_button_label' => 'Schedule a call',
				'primary_button_link'  => array(),
				'trust_line'           => 'Free 15-minute call',
			),
			'consultation',
			'subtle',
			array(
				'short_label'         => 'Consultation CTA',
				'suggested_use_cases' => array( 'Top-level', 'Hub', 'Service' ),
			)
		);
	}
	...
	public static function cta_consultation_02(): array {
		...
		return self::cta_definition(
			...
			array(
				...
				'body'                   => 'Book your consultation today.',
				'primary_button_label'   => 'Book now',
				'primary_button_link'    => array(),
				'secondary_button_label' => 'Learn more',
				'secondary_button_link'  => array(),
				'trust_line'             => 'Trusted by 1,000+ clients',
			),
			'consultation',
			'strong',
			array(
				'short_label'                           => 'Consultation CTA strong',
	...
	public static function cta_booking_02(): array {
		...
		return self::cta_definition(
			...
			array(
				...
				'primary_button_label' => 'See availability',
				'primary_button_link'  => array(),
				'image'                => array(),
			),
			'booking',
	...
	public static function cta_purchase_01(): array {
		...
		return self::cta_definition(
			...
			array(
				'heading'              => 'Add to cart',
				'body'                 => 'Complete your order in a few steps.',
	...
	public static function cta_purchase_02(): array {
		...
		return self::cta_definition(
			...
			array(
				...
				'body'                 => 'Fast delivery. Secure checkout.',
				'primary_button_label' => 'Buy now',
				'primary_button_link'  => array(),
				'trust_line'           => 'Secure payment',
			),
			'purchase',
			'strong',
	...
	public static function cta_inquiry_02(): array {
		...
		return self::cta_definition(
			...
			array(
				...
				'primary_button_label' => 'Send inquiry',
				'primary_button_link'  => array(),
				'trust_line'           => 'We reply within 24 hours',
			),
			'inquiry',
			'proof_backed',
	...
	public static function cta_contact_02(): array {
		...
		return self::cta_definition(
			...
			array(
				...
				'body'                   => 'Call, email, or visit.',
				'primary_button_label'   => 'Contact now',
				'primary_button_link'    => array(),
				'secondary_button_label' => 'View locations',
				'secondary_button_link'  => array(),
			),
			'contact',
			'strong',
	...
	public static function cta_quote_request_01(): array {
		...
		return self::cta_definition(
			...
			array(
				...
				'body'                 => '',
				'primary_button_label' => 'Get quote',
				'primary_button_link'  => array(),
			),
			'quote_request',
			'minimalist',
			array(
				'short_label'    => 'Quote CTA',
				'animation_tier' => 'none',
			)
		);
	}
	...
	public static function cta_quote_request_02(): array {
		...
		return self::cta_definition(
			...
			array(
				...
				'primary_button_label' => 'Request quote',
				'primary_button_link'  => array(),
				'trust_line'           => 'Free, no obligation',
			),
			'quote_request',
			'proof_backed',
	...
	public static function cta_directory_nav_01(): array {
		...
		return self::cta_definition(
			...
			array(
				'heading'              => 'Browse directory',
				'body'                 => 'Find what you need.',
				'primary_button_label' => 'View all',
				'primary_button_link'  => array(),
			),
			'directory_nav',
			'subtle',
	...
	public static function cta_compare_next_01(): array {
		...
		return self::cta_definition(
			...
			array(
				...
				'body'                 => '',
				'primary_button_label' => 'Compare now',
				'primary_button_link'  => array(),
			),
			'compare_next',
			'minimalist',
			array(
				'short_label'    => 'Compare CTA',
				'animation_tier' => 'none',
			)
		);
	}
	...
	public static function cta_trust_confirm_02(): array {
		...
		return self::cta_definition(
			...
			array(
				...
				'body'                 => 'Secure and trusted.',
				'primary_button_label' => 'Continue',
				'primary_button_link'  => array(),
				'trust_line'           => 'Trusted partner',
			),
			'trust_confirm',
			'strong',
	...
	public static function cta_local_action_01(): array {
		...
		return self::cta_definition(
			...
			array(
				'heading'              => 'Visit us',
				'body'                 => 'Find us nearby.',
				'primary_button_label' => 'Get directions',
				'primary_button_link'  => array(),
				'image'                => array(),
			),
			'local_action',
	...
	public static function cta_local_action_02(): array {
		...
		return self::cta_definition(
			...
			array(
				...
				'body'                 => '',
				'primary_button_label' => 'View map',
				'primary_button_link'  => array(),
			),
			'local_action',
			'minimalist',
			array(
				'short_label'    => 'Local CTA minimal',
				'animation_tier' => 'none',
			)
		);
	}
	...
	public static function cta_service_detail_01(): array {
		...
		return self::cta_definition(
			...
			array(
				...
				'body'                   => 'Schedule at your convenience.',
				'primary_button_label'   => 'Book now',
				'primary_button_link'    => array(),
				'secondary_button_label' => 'Learn more',
				'secondary_button_link'  => array(),
	...
	public static function cta_product_detail_01(): array {
		...
		return self::cta_definition(
			...
			array(
				'heading'              => 'Add to cart',
				'body'                 => 'Available for fast delivery.',
				'primary_button_label' => 'Add to cart',
				'primary_button_link'  => array(),
				'image'                => array(),
			),
	...
	public static function cta_product_detail_02(): array {
		...
		return self::cta_definition(
			...
			array(
				'heading'              => 'Buy now',
				'body'                 => 'Secure checkout. Fast shipping.',
				'primary_button_label' => 'Buy now',
				'primary_button_link'  => array(),
				'trust_line'           => 'Free returns',
			),
			'product_detail',
			'strong',
	...
	public static function cta_support_01(): array {
		...
		return self::cta_definition(
			...
			array(
				'heading'              => 'Need help?',
				'body'                 => '',
				'primary_button_label' => 'Contact support',
				'primary_button_link'  => array(),
			),
			'support',
			'minimalist',
			array(
				'short_label'    => 'Support CTA',
				'animation_tier' => 'none',
			)
		);
	}
	...
	public static function cta_support_02(): array {
		...
		return self::cta_definition(
			...
			array(
				...
				'body'                 => 'Reach support 24/7.',
				'primary_button_label' => 'Get support',
				'primary_button_link'  => array(),
				'trust_line'           => '24/7 support',
			),
			'support',
			'proof_backed',
	...
	public static function cta_policy_utility_02(): array {
		...
		return self::cta_definition(
			...
			'minimalist',
			array(
				'short_label'    => 'Policy CTA minimal',
				'animation_tier' => 'none',
			)
		);
	}
