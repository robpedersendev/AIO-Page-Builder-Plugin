...
final class Hero_Intro_Library_Batch_Definitions {
	...
	private static function common_hero_blueprint_fields(): array {
		return array(
			array( 'key' => 'field_hero_headline', 'name' => 'headline', 'label' => 'Headline', 'type' => 'text', 'required' => true, 'instructions' => 'Main hero headline.' ),
			array( 'key' => 'field_hero_subheadline', 'name' => 'subheadline', 'label' => 'Subheadline', 'type' => 'textarea', 'required' => false, 'instructions' => 'Supporting line.' ),
			array( 'key' => 'field_hero_eyebrow', 'name' => 'eyebrow', 'label' => 'Eyebrow', 'type' => 'text', 'required' => false, 'instructions' => 'Optional eyebrow text.' ),
			array( 'key' => 'field_hero_primary_cta', 'name' => 'primary_cta', 'label' => 'Primary CTA', 'type' => 'link', 'required' => false, 'instructions' => 'Main call-to-action link.' ),
			array( 'key' => 'field_hero_secondary_cta', 'name' => 'secondary_cta', 'label' => 'Secondary link', 'type' => 'link', 'required' => false, 'instructions' => 'Optional secondary link.' ),
		);
	}
	...
	public static function hero_conv_01(): array {
		return self::hero_definition(
			...
			array( 'headline' => 'Get started today', 'subheadline' => 'Supporting copy for your main offer.', 'eyebrow' => '', 'primary_cta' => array( 'url' => '#', 'title' => 'Sign up' ), 'secondary_cta' => array() ),
			array( 'short_label' => 'Hero CTA', 'suggested_use_cases' => array( 'Landing page', 'Sign-up flow', 'Offer page opener' ) )
		);
	}
	...
	public static function hero_dir_01(): array {
		return self::hero_definition(
			...
			self::common_hero_blueprint_fields(),
			array( 'headline' => 'Browse our directory', 'subheadline' => 'Find what you need.', 'eyebrow' => 'Directory', 'primary_cta' => array( 'url' => '#', 'title' => 'Browse' ), 'secondary_cta' => array() ),
			array( 'short_label' => 'Hero directory', 'suggested_use_cases' => array( 'Directory hub', 'Listing page', 'Catalog opener' ) )
		);
	}
	...
	public static function hero_edit_01(): array {
		return self::hero_definition(
			...
			self::common_hero_blueprint_fields(),
			array( 'headline' => 'Article or resource title', 'subheadline' => 'Brief introduction or summary.', 'eyebrow' => 'Resource', 'primary_cta' => array( 'url' => '#', 'title' => 'Read more' ), 'secondary_cta' => array() ),
			array( 'short_label' => 'Hero editorial', 'suggested_use_cases' => array( 'Article opener', 'Resource page', 'Blog post' ) )
		);
	}
	...
	public static function hero_compact_01(): array {
		...
		return self::hero_definition(
			...
			'Compact hero layout.',
			$fields,
			array( 'headline' => 'Short headline', 'subheadline' => '', 'eyebrow' => '', 'primary_cta' => array( 'url' => '#', 'title' => 'Go' ), 'secondary_cta' => array() ),
			array(
	...
	public static function hero_media_01(): array {
		$fields = array_merge(
			self::common_hero_blueprint_fields(),
			array( array( 'key' => 'field_hero_media_image', 'name' => 'hero_image', 'label' => 'Hero image', 'type' => 'image', 'required' => false, 'instructions' => 'Optional hero image.' ) )
		);
		return self::hero_definition(
			'hero_media_01',
			'Hero media-forward',
	...
	public static function hero_split_01(): array {
		$fields = array_merge(
			self::common_hero_blueprint_fields(),
			array( array( 'key' => 'field_hero_split_image', 'name' => 'split_image', 'label' => 'Split image', 'type' => 'image', 'required' => false, 'instructions' => 'Image for split layout.' ) )
		);
		return self::hero_definition(
			'hero_split_01',
			'Hero split layout',
			...
			$fields,
			array( 'headline' => 'Headline', 'subheadline' => 'Copy on one side.', 'eyebrow' => '', 'primary_cta' => array( 'url' => '#', 'title' => 'CTA' ), 'secondary_cta' => array(), 'split_image' => array() ),
			array(
