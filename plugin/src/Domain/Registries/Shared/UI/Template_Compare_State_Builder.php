...
final class Template_Compare_State_Builder {
	...
	private function build_section_compare_row( string $key, array $definition ): array {
		...
		$detail_url = \add_query_arg( array( 'page' => 'aio-page-builder-section-template-detail', 'section' => $key ), \admin_url( 'admin.php' ) );
	...
	private function build_page_compare_row( string $key, array $definition ): array {
		...
		$detail_url  = \add_query_arg( array( 'page' => 'aio-page-builder-page-template-detail', 'template' => $key ), \admin_url( 'admin.php' ) );
