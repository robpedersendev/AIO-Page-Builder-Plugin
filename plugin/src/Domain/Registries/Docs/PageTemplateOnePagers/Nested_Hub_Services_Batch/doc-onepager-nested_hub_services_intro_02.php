...
$sections = array(
	'hero_dir_01' => 'Directory hero. See doc-helper-hero_dir_01.', 'mlp_listing_01' => 'Listing. See doc-helper-mlp_listing_01.', 'fb_service_offering_01' => 'Service offering. See doc-helper-fb_service_offering_01.', 'cta_service_detail_02' => 'Service detail CTA. See doc-helper-cta_service_detail_02.', 'tp_testimonial_01' => 'Testimonial. See doc-helper-tp_testimonial_01.', 'ptf_service_flow_01' => 'Service flow. See doc-helper-ptf_service_flow_01.', 'cta_consultation_01' => 'Consultation CTA. See doc-helper-cta_consultation_01.', 'mlp_card_grid_01' => 'Card grid. See doc-helper-mlp_card_grid_01.', 'fb_why_choose_01' => 'Why choose. See doc-helper-fb_why_choose_01.', 'tp_trust_band_01' => 'Trust band. See doc-helper-tp_trust_band_01.', 'cta_booking_01' => 'Booking CTA. See doc-helper-cta_booking_01.', 'lpu_contact_panel_01' => 'Contact panel. See doc-helper-lpu_contact_panel_01.', 'cta_contact_01' => 'Contact CTA. See doc-helper-cta_contact_01.',
);
$li = '';
foreach ( $sections as $k => $v ) {
	$li .= '<li><strong>' . $k . '</strong>: ' . $v . '</li>';
}
$purpose = 'Service subcategory intro listing-led. Listing and offering; service CTA; testimonial and flow; consultation CTA; cards and why choose; trust band and booking CTA; contact panel; contact CTA.';
$flow    = 'Listing-led subcategory intro; drill-down and category navigation. Beneath Services hub; listing supports filtered subcategory browsing and detail drill-down.';
return array(
