...
$aio_pb_purpose = 'Locations hub regional. Local value and location info; local CTA; place highlight and card grid; reassurance and local CTA; contact detail and panel; expectations and contact CTA; listing; directory nav CTA.';
$aio_pb_flow    = 'Regional emphasis; local and contact and directory CTAs for drill-down.';
return array(
