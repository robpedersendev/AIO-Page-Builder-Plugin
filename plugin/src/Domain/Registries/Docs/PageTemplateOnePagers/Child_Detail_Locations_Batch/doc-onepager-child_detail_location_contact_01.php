...
$aio_pb_purpose = 'Single location detail with contact/visit emphasis. Contact detail and panel early; multiple contact and local CTAs; booking last.';
$aio_pb_flow    = 'Contact and visit path prominent; directory and booking support. Contact, local action, contact, directory nav, booking; last CTA booking.';
return array(
