...
final class Industry_LPagery_Planning_Result {
	 ...
	 * @param list<string> $required_tokens       Token refs required when LPagery is used.
	 * @param list<string> $optional_tokens       Optional token refs.
	 * @param list<string> $suggested_page_families Advisory page family or hierarchy hints.
	 * @param list<string> $warning_flags         Warning codes for planning/UI.
	 * @param string       $hierarchy_guidance     Concatenated hierarchy guidance from rules.
	 * @param list<string> $weak_page_warnings    Page types or patterns that are weak fit.
	 */
