...
final class Industry_Override_Audit_Report_Service {
	...
	public function build_report(): array {
		...
		$by_type             = array(
			Industry_Override_Schema::TARGET_TYPE_SECTION => array(
				'count' => 0,
				'items' => array(),
			),
			Industry_Override_Schema::TARGET_TYPE_PAGE_TEMPLATE => array(
				'count' => 0,
				'items' => array(),
			),
			Industry_Override_Schema::TARGET_TYPE_BUILD_PLAN_ITEM => array(
				'count' => 0,
				'items' => array(),
			),
		);
