	...
	private function overrides_cosmetology_nail(): array {
		return array(
			...
			'proof'  => array(
				...
				'items'    => array(
					array( 'name' => 'Sarah M.', 'quote' => 'Always leave feeling refreshed and looking great.', 'role' => 'Client' ),
					array( 'name' => 'Jessica L.', 'quote' => 'Professional service and a relaxing atmosphere.', 'role' => 'Regular' ),
				),
			),
			'cta'    => array(
			...
			'offer'  => array(
				...
				'plans'    => array(
					array( 'title' => 'Manicure', 'price' => '$XX', 'features' => 'Classic or gel; nail art optional.' ),
					array( 'title' => 'Pedicure', 'price' => '$YY', 'features' => 'Relaxing soak and finish.' ),
				),
			),
			'faq'    => array(
				'headline' => 'Frequently Asked Questions',
				'items'    => array(
					array( 'question' => 'How do I book an appointment?', 'answer' => 'Use our booking link or call the salon during business hours.' ),
					array( 'question' => 'Do you offer walk-ins?', 'answer' => 'Walk-ins are welcome when we have availability.' ),
				),
			),
			'profile' => array(
				'headline' => 'Our Team',
			...
			'listing' => array(
				...
				'items'    => array(
					array( 'title' => 'Manicure & Nail Care', 'description' => 'Classic and gel options.', 'link' => self::PLACEHOLDER_URL ),
					array( 'title' => 'Pedicure', 'description' => 'Spa-style foot care.', 'link' => self::PLACEHOLDER_URL ),
				),
			),
		);
	}
	...
	private function overrides_realtor(): array {
		return array(
			...
			'proof'  => array(
				...
				'items'    => array(
					array( 'name' => 'Buyer Client', 'quote' => 'Made the process smooth from search to closing.', 'role' => 'Buyer' ),
					array( 'name' => 'Seller Client', 'quote' => 'Sold above asking. Highly recommend.', 'role' => 'Seller' ),
				),
			),
			'cta'    => array(
			...
			'offer'  => array(
				...
				'plans'    => array(
					array( 'title' => 'Buyer representation', 'price' => 'Contact', 'features' => 'Search, tours, negotiation, closing.' ),
					array( 'title' => 'Seller representation', 'price' => 'Contact', 'features' => 'Pricing, marketing, offers, closing.' ),
				),
			),
			'faq'    => array(
				'headline' => 'Frequently Asked Questions',
				'items'    => array(
					array( 'question' => 'How is my home value estimated?', 'answer' => 'We use local comparables and market data for a free estimate.' ),
					array( 'question' => 'What areas do you serve?', 'answer' => 'We focus on the local market and surrounding neighborhoods.' ),
				),
			),
			'listing' => array(
				'headline' => 'Featured Listings',
				'items'    => array(
					array( 'title' => 'Neighborhood A Home', 'description' => '3 bed, 2 bath. Great location.', 'link' => self::PLACEHOLDER_URL ),
					array( 'title' => 'Neighborhood B Home', 'description' => 'Family-friendly area.', 'link' => self::PLACEHOLDER_URL ),
				),
			),
			'locations' => array(
	...
	private function overrides_plumber(): array {
		return array(
			...
			'proof'  => array(
				...
				'items'    => array(
					array( 'name' => 'Homeowner', 'quote' => 'Fast, professional, and fairly priced.', 'role' => 'Customer' ),
					array( 'name' => 'Property Manager', 'quote' => 'Reliable for our emergency calls.', 'role' => 'Client' ),
				),
			),
			'cta'    => array(
			...
			'offer'  => array(
				...
				'plans'    => array(
					array( 'title' => 'Repairs', 'price' => 'Quote', 'features' => 'Leaks, clogs, fixtures, water heaters.' ),
					array( 'title' => 'Installations', 'price' => 'Quote', 'features' => 'New fixtures, water heaters, repipes.' ),
				),
			),
			'faq'    => array(
				'headline' => 'Frequently Asked Questions',
				'items'    => array(
					array( 'question' => 'Do you offer emergency service?', 'answer' => 'Yes. Call for same-day or after-hours emergency response.' ),
					array( 'question' => 'Are you licensed?', 'answer' => 'Yes. We are fully licensed and insured.' ),
				),
			),
			'explainer' => array(
				'headline' => 'How We Work',
				'steps'    => array(
					array( 'title' => 'Call or book', 'description' => 'Describe the issue and schedule a visit.' ),
					array( 'title' => 'Diagnosis', 'description' => 'We assess the problem and provide a clear quote.' ),
					array( 'title' => 'Repair or install', 'description' => 'We complete the work and clean up.' ),
				),
			),
		);
	}
	...
	private function overrides_disaster_recovery(): array {
		return array(
			...
			'proof'  => array(
				...
				'items'    => array(
					array( 'name' => 'Property Owner', 'quote' => 'They were here within the hour. Professional and thorough.', 'role' => 'Client' ),
					array( 'name' => 'Insurance Partner', 'quote' => 'Certified and reliable for mitigation and restoration.', 'role' => 'Partner' ),
				),
			),
			'cta'    => array(
			...
			'offer'  => array(
				...
				'plans'    => array(
					array( 'title' => 'Water damage', 'price' => 'Assessment', 'features' => 'Extraction, drying, sanitization.' ),
					array( 'title' => 'Fire & smoke', 'price' => 'Assessment', 'features' => 'Board-up, cleaning, odor removal.' ),
				),
			),
			'faq'    => array(
				'headline' => 'Frequently Asked Questions',
				'items'    => array(
					array( 'question' => 'Do you work with insurance?', 'answer' => 'Yes. We work with most carriers and can help with the claims process.' ),
					array( 'question' => 'How fast can you respond?', 'answer' => 'We offer 24/7 emergency dispatch. Response time depends on location.' ),
				),
			),
			'explainer' => array(
				'headline' => 'What Happens Next',
				'steps'    => array(
					array( 'title' => 'Call', 'description' => 'Contact us 24/7 to report the damage.' ),
					array( 'title' => 'Assessment', 'description' => 'We assess the damage and document for insurance.' ),
					array( 'title' => 'Mitigation & restore', 'description' => 'We stabilize the property and restore it.' ),
				),
			),
		);
	}
