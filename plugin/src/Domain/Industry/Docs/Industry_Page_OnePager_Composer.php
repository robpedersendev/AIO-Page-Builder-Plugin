...
final class Industry_Page_OnePager_Composer {
	...
	public function __construct( Documentation_Registry $documentation_registry, Industry_Page_OnePager_Overlay_Registry $overlay_registry ) {
	...
	public function compose( string $page_template_key, string $industry_key ): Composed_Page_OnePager_Result {
		...
		return new Composed_Page_OnePager_Result( $composed, $base_id, $overlay_applied, $overlay_industry, $page_template_key );
	}
}
