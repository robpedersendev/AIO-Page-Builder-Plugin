<?php
/**
 * Secondary-goal starter-bundle overlay: primary bookings + secondary consultation (Prompt 542).
 *
...
return array(
	array(
		Secondary_Goal_Starter_Bundle_Overlay_Registry::FIELD_OVERLAY_KEY             => 'bookings_consultation',
		Secondary_Goal_Starter_Bundle_Overlay_Registry::FIELD_PRIMARY_GOAL_KEY      => 'bookings',
		Secondary_Goal_Starter_Bundle_Overlay_Registry::FIELD_SECONDARY_GOAL_KEY    => 'consultations',
		...
		Secondary_Goal_Starter_Bundle_Overlay_Registry::FIELD_SECTION_EMPHASIS       => array( 'cta_consultation_01' ),
		Secondary_Goal_Starter_Bundle_Overlay_Registry::FIELD_CTA_POSTURE           => 'book-first-with-consult-option',
		Secondary_Goal_Starter_Bundle_Overlay_Registry::FIELD_FUNNEL_SHAPE           => 'direct-conversion-with-consult',
