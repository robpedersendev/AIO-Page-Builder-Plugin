 ...
 * rollback-eligibility indicators, and immutable audit trail display. No rollback execution.
 *
...
final class History_Rollback_Step_UI_Service {
	...
	public function build_workspace(
		...
		$bulk_states = array(
			Bulk_Action_Bar_Component::CONTROL_APPLY_TO_ALL     => array( 'enabled' => false, 'label' => \__( 'Rollback', 'aio-page-builder' ), 'count_eligible' => 0 ),
			Bulk_Action_Bar_Component::CONTROL_APPLY_TO_SELECTED => array( 'enabled' => false, 'label' => \__( 'Rollback selected', 'aio-page-builder' ), 'count_selected' => 0 ),
			Bulk_Action_Bar_Component::CONTROL_DENY_ALL        => array( 'enabled' => false, 'label' => \__( 'N/A', 'aio-page-builder' ), 'count_eligible' => 0 ),
			Bulk_Action_Bar_Component::CONTROL_CLEAR_SELECTION => array( 'enabled' => false, 'label' => \__( 'Clear selection', 'aio-page-builder' ) ),
		);
		$detail_panel = array(
			'item_id'     => $selected_item_id ?? '',
			'sections'    => array(
				array( 'heading' => \__( 'Before / after snapshot', 'aio-page-builder' ), 'key' => 'snapshot', 'content_lines' => array( \__( 'Placeholder — no snapshot capture in this step.', 'aio-page-builder' ) ) ),
				array( 'heading' => \__( 'Audit trail', 'aio-page-builder' ), 'key' => 'audit', 'content_lines' => array( \__( 'Immutable audit trail (placeholder).', 'aio-page-builder' ) ) ),
			),
			'row_actions' => array(),
		);
		$step_messages = array(
	...
	private function empty_workspace(): array {
		return array(
			...
			'step_messages'                  => array(),
			'history_summary'                => array( 'total_events' => 0, 'grouped_by' => '' ),
