...
final class Section_Template_Detail_Screen {
	...
	private function render_entity_style_panel( array $entity_style ): void {
		...
		<form method="post" action="<?php echo \esc_url( $detail_url ); ?>" class="aio-entity-style-form">
			...
			<?php endforeach; ?>
			<p><button type="submit" class="button button-primary" data-aio-ux-action="section_template_detail_save_styling" data-aio-ux-section="section_template_detail_style" data-aio-ux-hub="<?php echo \esc_attr( self::SLUG ); ?>" data-aio-ux-tab="detail"><?php \esc_html_e( 'Save styling', 'aio-page-builder' ); ?></button></p>
		</form>
		<?php
	}
