		...
		<?php endif; ?>
			...
			<div class="aio-dashboard-widgets" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: 1em; margin-top: 1.5em;">
				<section class="aio-dashboard-widget aio-widget-health" aria-labelledby="aio-widget-health-heading">
					...
					<p><a href="<?php echo esc_url( $vm->get_links()['health_report'] ?? '#' ); ?>"<?php echo $this->author_ux_link_attrs( 'industry_author_link_health_report', 'aio-widget-health' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- data-aio-ux-* built with esc_attr in author_ux_link_attrs(). ?>><?php esc_html_e( 'Health Report', 'aio-page-builder' ); ?></a></p>
				</section>
				...
				<section class="aio-dashboard-widget aio-widget-blockers" aria-labelledby="aio-widget-blockers-heading">
					...
					<p><a href="<?php echo esc_url( $vm->get_links()['health_report'] ?? '#' ); ?>"<?php echo $this->author_ux_link_attrs( 'industry_author_link_health_report', 'aio-widget-blockers' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- data-aio-ux-* built with esc_attr in author_ux_link_attrs(). ?>><?php esc_html_e( 'Health Report', 'aio-page-builder' ); ?></a></p>
				</section>
				...
				<section class="aio-dashboard-widget aio-widget-future-expansion" aria-labelledby="aio-widget-future-expansion-heading">
					...
					<p><a href="<?php echo esc_url( $expansion_vm->get_links()['pack_family_comparison'] ?? '#' ); ?>"<?php echo $this->author_ux_link_attrs( 'industry_author_link_pack_family_comparison', 'aio-widget-future-expansion' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- data-aio-ux-* built with esc_attr in author_ux_link_attrs(). ?>><?php esc_html_e( 'Pack family comparison', 'aio-page-builder' ); ?></a> &middot; <a href="<?php echo esc_url( $expansion_vm->get_links()['future_industry_readiness'] ?? '#' ); ?>"<?php echo $this->author_ux_link_attrs( 'industry_author_link_future_industry_readiness', 'aio-widget-future-expansion' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- data-aio-ux-* built with esc_attr in author_ux_link_attrs(). ?>><?php esc_html_e( 'Future industry readiness', 'aio-page-builder' ); ?></a> &middot; <a href="<?php echo esc_url( $expansion_vm->get_links()['future_subtype_readiness'] ?? '#' ); ?>"<?php echo $this->author_ux_link_attrs( 'industry_author_link_future_subtype_readiness', 'aio-widget-future-expansion' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- data-aio-ux-* built with esc_attr in author_ux_link_attrs(). ?>><?php esc_html_e( 'Future subtype readiness', 'aio-page-builder' ); ?></a></p>
				</section>
			</div>
			...
			<section class="aio-dashboard-links" style="margin-top: 2em;" aria-labelledby="aio-dashboard-links-heading">
				...
				<ul>
					<li><a href="<?php echo esc_url( $vm->get_links()['industry_profile'] ?? '#' ); ?>"<?php echo $this->author_ux_link_attrs( 'industry_author_quick_industry_profile', 'aio-dashboard-quick-links' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- data-aio-ux-* built with esc_attr in author_ux_link_attrs(). ?>><?php esc_html_e( 'Industry Profile', 'aio-page-builder' ); ?></a></li>
					<li><a href="<?php echo esc_url( $vm->get_links()['health_report'] ?? '#' ); ?>"<?php echo $this->author_ux_link_attrs( 'industry_author_quick_health_report', 'aio-dashboard-quick-links' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- data-aio-ux-* built with esc_attr in author_ux_link_attrs(). ?>><?php esc_html_e( 'Industry Health Report', 'aio-page-builder' ); ?></a></li>
					<li><a href="<?php echo esc_url( $vm->get_links()['stale_content_report'] ?? '#' ); ?>"<?php echo $this->author_ux_link_attrs( 'industry_author_quick_stale_content', 'aio-dashboard-quick-links' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- data-aio-ux-* built with esc_attr in author_ux_link_attrs(). ?>><?php esc_html_e( 'Stale content report', 'aio-page-builder' ); ?></a></li>
					<li><a href="<?php echo esc_url( $vm->get_links()['pack_family_comparison'] ?? '#' ); ?>"<?php echo $this->author_ux_link_attrs( 'industry_author_quick_pack_family', 'aio-dashboard-quick-links' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- data-aio-ux-* built with esc_attr in author_ux_link_attrs(). ?>><?php esc_html_e( 'Pack family comparison', 'aio-page-builder' ); ?></a></li>
					<li><a href="<?php echo esc_url( $vm->get_links()['future_industry_readiness'] ?? '#' ); ?>"<?php echo $this->author_ux_link_attrs( 'industry_author_quick_future_industry', 'aio-dashboard-quick-links' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- data-aio-ux-* built with esc_attr in author_ux_link_attrs(). ?>><?php esc_html_e( 'Future industry readiness', 'aio-page-builder' ); ?></a></li>
					<li><a href="<?php echo esc_url( $vm->get_links()['future_subtype_readiness'] ?? '#' ); ?>"<?php echo $this->author_ux_link_attrs( 'industry_author_quick_future_subtype', 'aio-dashboard-quick-links' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- data-aio-ux-* built with esc_attr in author_ux_link_attrs(). ?>><?php esc_html_e( 'Future subtype readiness', 'aio-page-builder' ); ?></a></li>
					<li><a href="<?php echo esc_url( $vm->get_links()['maturity_delta_report'] ?? '#' ); ?>"<?php echo $this->author_ux_link_attrs( 'industry_author_quick_maturity_delta', 'aio-dashboard-quick-links' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- data-aio-ux-* built with esc_attr in author_ux_link_attrs(). ?>><?php esc_html_e( 'Maturity delta report', 'aio-page-builder' ); ?></a></li>
					<li><a href="<?php echo esc_url( $vm->get_links()['drift_report'] ?? '#' ); ?>"<?php echo $this->author_ux_link_attrs( 'industry_author_quick_drift', 'aio-dashboard-quick-links' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- data-aio-ux-* built with esc_attr in author_ux_link_attrs(). ?>><?php esc_html_e( 'Drift report', 'aio-page-builder' ); ?></a></li>
					<li><a href="<?php echo esc_url( $vm->get_links()['scaffold_promotion_readiness'] ?? '#' ); ?>"<?php echo $this->author_ux_link_attrs( 'industry_author_quick_scaffold_promotion', 'aio-dashboard-quick-links' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- data-aio-ux-* built with esc_attr in author_ux_link_attrs(). ?>><?php esc_html_e( 'Scaffold promotion readiness', 'aio-page-builder' ); ?></a></li>
					<li><a href="<?php echo esc_url( $vm->get_links()['guided_repair'] ?? '#' ); ?>"<?php echo $this->author_ux_link_attrs( 'industry_author_quick_guided_repair', 'aio-dashboard-quick-links' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- data-aio-ux-* built with esc_attr in author_ux_link_attrs(). ?>><?php esc_html_e( 'Guided Repair', 'aio-page-builder' ); ?></a></li>
					<li><a href="<?php echo esc_url( $vm->get_links()['subtype_comparison'] ?? '#' ); ?>"<?php echo $this->author_ux_link_attrs( 'industry_author_quick_subtype_comparison', 'aio-dashboard-quick-links' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- data-aio-ux-* built with esc_attr in author_ux_link_attrs(). ?>><?php esc_html_e( 'Subtype comparison', 'aio-page-builder' ); ?></a></li>
					<li><a href="<?php echo esc_url( $vm->get_links()['bundle_comparison'] ?? '#' ); ?>"<?php echo $this->author_ux_link_attrs( 'industry_author_quick_bundle_comparison', 'aio-dashboard-quick-links' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- data-aio-ux-* built with esc_attr in author_ux_link_attrs(). ?>><?php esc_html_e( 'Bundle comparison', 'aio-page-builder' ); ?></a></li>
					<li><a href="<?php echo esc_url( $vm->get_links()['goal_comparison'] ?? '#' ); ?>"<?php echo $this->author_ux_link_attrs( 'industry_author_quick_goal_comparison', 'aio-dashboard-quick-links' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- data-aio-ux-* built with esc_attr in author_ux_link_attrs(). ?>><?php esc_html_e( 'Conversion goal comparison', 'aio-page-builder' ); ?></a></li>
				</ul>
			</section>
