...
final class Template_Accessibility_Audit_Service_Test extends TestCase {
	...
	public function test_heading_rule_detection(): void {
		$section = $this->section_def(
			'st_hero_no_hints',
			array(
				'hierarchy_role_hints'   => null,
				'section_purpose_family' => 'hero',
			)
		);
		...
		$heading_violations = array_filter(
			$violations,
			function ( $v ) {
	...
	public function test_bottom_cta_missing(): void {
		...
		$ordered = array(
			...
			array(
				Page_Template_Schema::SECTION_ITEM_KEY => 'st_non',
	...
	public function test_passed_when_no_violations(): void {
		...
		$ordered  = array(
			...
			array(
				Page_Template_Schema::SECTION_ITEM_KEY => 'st_non1',
				Page_Template_Schema::SECTION_ITEM_POSITION => 1,
				Page_Template_Schema::SECTION_ITEM_REQUIRED => true,
			),
			array(
				Page_Template_Schema::SECTION_ITEM_KEY => 'st_non2',
				Page_Template_Schema::SECTION_ITEM_POSITION => 2,
				Page_Template_Schema::SECTION_ITEM_REQUIRED => true,
			),
			array(
				Page_Template_Schema::SECTION_ITEM_KEY => 'st_cta1',
				Page_Template_Schema::SECTION_ITEM_POSITION => 3,
				Page_Template_Schema::SECTION_ITEM_REQUIRED => true,
			),
			array(
				Page_Template_Schema::SECTION_ITEM_KEY => 'st_non3',
				Page_Template_Schema::SECTION_ITEM_POSITION => 4,
				Page_Template_Schema::SECTION_ITEM_REQUIRED => true,
			),
			array(
				Page_Template_Schema::SECTION_ITEM_KEY => 'st_non4',
				Page_Template_Schema::SECTION_ITEM_POSITION => 5,
				Page_Template_Schema::SECTION_ITEM_REQUIRED => true,
			),
			array(
				Page_Template_Schema::SECTION_ITEM_KEY => 'st_cta2',
				Page_Template_Schema::SECTION_ITEM_POSITION => 6,
				Page_Template_Schema::SECTION_ITEM_REQUIRED => true,
			),
			array(
				Page_Template_Schema::SECTION_ITEM_KEY => 'st_non5',
				Page_Template_Schema::SECTION_ITEM_POSITION => 7,
				Page_Template_Schema::SECTION_ITEM_REQUIRED => true,
			),
			array(
				Page_Template_Schema::SECTION_ITEM_KEY => 'st_non6',
				Page_Template_Schema::SECTION_ITEM_POSITION => 8,
				Page_Template_Schema::SECTION_ITEM_REQUIRED => true,
			),
			array(
				Page_Template_Schema::SECTION_ITEM_KEY => 'st_non7',
				Page_Template_Schema::SECTION_ITEM_POSITION => 9,
				Page_Template_Schema::SECTION_ITEM_REQUIRED => true,
			),
			array(
				Page_Template_Schema::SECTION_ITEM_KEY => 'st_cta_end',
				Page_Template_Schema::SECTION_ITEM_POSITION => 10,
				Page_Template_Schema::SECTION_ITEM_REQUIRED => true,
			),
		);
