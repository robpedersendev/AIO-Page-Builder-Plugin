...
final class Prompt_Experiment_Service_Test extends TestCase {
	...
	public function test_validate_definition_requires_name(): void {
		...
		$def = array( 'variants' => array( array( 'variant_id' => 'v1', 'label' => 'V1', 'prompt_pack_ref' => array( 'internal_key' => 'aio/pack', 'version' => '1.0' ), 'provider_id' => 'openai' ) ) );
	...
	public function test_validate_definition_requires_variants(): void {
		$service = $this->get_service();
		$def = array( 'name' => 'Test', 'variants' => array() );
	...
	public function test_validate_definition_valid(): void {
		...
		$def = array(
			'name'    => 'Test',
			'variants' => array(
				array( 'variant_id' => 'v1', 'label' => 'Baseline', 'prompt_pack_ref' => array( 'internal_key' => 'aio/build-plan-draft', 'version' => '1.0.0' ), 'provider_id' => 'openai' ),
			),
		);
	...
	public function test_save_and_list_definitions(): void {
		...
		$def = array(
			'name'     => 'Compare packs',
			'variants' => array(
				array( 'variant_id' => 'v1', 'label' => 'Pack A', 'prompt_pack_ref' => array( 'internal_key' => 'aio/pack', 'version' => '1.0' ), 'provider_id' => 'openai' ),
			),
		);
	...
	public function test_record_experiment_run_persists_and_labels(): void {
		...
		$def = array(
			'name'     => 'Exp',
			'variants' => array(
				array( 'variant_id' => 'v1', 'label' => 'V1', 'prompt_pack_ref' => array( 'internal_key' => 'aio/pack', 'version' => '1.0' ), 'provider_id' => 'openai' ),
			),
		);
		...
		$metadata = array(
			...
			'provider_id'     => 'openai',
			'model_used'      => 'gpt-4o',
			'prompt_pack_ref' => array( 'internal_key' => 'aio/pack', 'version' => '1.0' ),
			'request_id'      => 'req-1',
		);
		...
		$GLOBALS['_aio_wp_query_posts'] = array( (object) array( 'ID' => 1, 'post_type' => 'aio_ai_run', 'post_title' => $run_id, 'post_status' => 'publish', 'post_name' => '' ) );
	...
	public function test_comparison_summary_groups_by_variant(): void {
		...
		$def = array(
			'name'     => 'Exp2',
			'variants' => array(
				array( 'variant_id' => 'va', 'label' => 'Variant A', 'prompt_pack_ref' => array( 'internal_key' => 'aio/pack', 'version' => '1.0' ), 'provider_id' => 'openai' ),
				array( 'variant_id' => 'vb', 'label' => 'Variant B', 'prompt_pack_ref' => array( 'internal_key' => 'aio/pack', 'version' => '2.0' ), 'provider_id' => 'anthropic' ),
			),
		);
		$service->save_definition( $def );
		$exp_id = $service->list_definitions()[0]['id'] ?? '';

		$meta = array( 'actor' => '1', 'created_at' => gmdate( 'Y-m-d\TH:i:s\Z' ), 'completed_at' => gmdate( 'Y-m-d\TH:i:s\Z' ), 'provider_id' => 'openai', 'model_used' => 'gpt-4o', 'prompt_pack_ref' => array(), 'request_id' => 'r1' );
		...
		$GLOBALS['_aio_wp_query_posts'] = array(
			(object) array( 'ID' => 1, 'post_type' => 'aio_ai_run', 'post_title' => 'run-va-1', 'post_status' => 'publish', 'post_name' => '' ),
			(object) array( 'ID' => 2, 'post_type' => 'aio_ai_run', 'post_title' => 'run-vb-1', 'post_status' => 'publish', 'post_name' => '' ),
		);
	...
	public function test_production_run_has_no_experiment_label(): void {
		...
		$metadata = array( 'actor' => '1', 'created_at' => gmdate( 'Y-m-d\TH:i:s\Z' ), 'provider_id' => 'openai', 'model_used' => 'gpt-4o', 'prompt_pack_ref' => array(), 'request_id' => 'r1' );
		$post_id = $run_service->create_run( $run_id, $metadata, 'completed', array() );
		$this->assertGreaterThan( 0, $post_id );
		$GLOBALS['_aio_get_post_return'] = new \WP_Post( array( 'ID' => 42, 'post_type' => 'aio_ai_run', 'post_title' => $run_id, 'post_status' => 'publish', 'post_name' => '' ) );
	...
	public function test_example_experiment_run_summary_payload(): void {
		...
		$def = array(
			...
			'variants' => array(
				array( 'variant_id' => 'v1', 'label' => 'Baseline', 'prompt_pack_ref' => array( 'internal_key' => 'aio/build-plan-draft', 'version' => '1.0.0' ), 'provider_id' => 'openai' ),
				array( 'variant_id' => 'v2', 'label' => 'Alternate', 'prompt_pack_ref' => array( 'internal_key' => 'aio/build-plan-draft', 'version' => '1.1.0' ), 'provider_id' => 'anthropic' ),
			),
		);
		$service->save_definition( $def );
		$exp_id = $service->list_definitions()[0]['id'] ?? '';
		$meta = array( 'actor' => '1', 'created_at' => '2025-03-12T12:00:00Z', 'completed_at' => '2025-03-12T12:00:05Z', 'provider_id' => 'openai', 'model_used' => 'gpt-4o', 'prompt_pack_ref' => array(), 'request_id' => 'req-1' );
