...
final class Industry_Substitute_Suggestion_Engine_Test extends TestCase {
	...
	public function test_result_from_array_normalizes(): void {
		$r = Industry_Substitute_Suggestion_Result::from_array( array( 'original_key' => 'x', 'suggested_replacement_key' => 'y' ) );
	...
	public function test_section_substitutes_empty_when_fit_recommended(): void {
		$result = new Industry_Section_Recommendation_Result( array(
			array( 'section_key' => 's1', 'score' => 50, 'fit_classification' => 'recommended', 'explanation_reasons' => array(), 'industry_source_refs' => array(), 'warning_flags' => array() ),
		) );
	...
	public function test_section_substitutes_returns_better_fit_same_family_first(): void {
		$items = array(
			array( 'section_key' => 'discouraged_1', 'score' => -20, 'fit_classification' => 'discouraged', 'explanation_reasons' => array(), 'industry_source_refs' => array(), 'warning_flags' => array() ),
			array( 'section_key' => 'rec_same_fam', 'score' => 40, 'fit_classification' => 'recommended', 'explanation_reasons' => array(), 'industry_source_refs' => array(), 'warning_flags' => array() ),
			array( 'section_key' => 'rec_other', 'score' => 50, 'fit_classification' => 'recommended', 'explanation_reasons' => array(), 'industry_source_refs' => array(), 'warning_flags' => array() ),
		);
		$result = new Industry_Section_Recommendation_Result( $items );
		$defs = array(
			array( 'internal_key' => 'discouraged_1', 'section_purpose_family' => 'offer' ),
			array( 'internal_key' => 'rec_same_fam', 'section_purpose_family' => 'offer' ),
			array( 'internal_key' => 'rec_other', 'section_purpose_family' => 'explainer' ),
		);
	...
	public function test_template_substitutes_empty_when_no_recommended_candidates(): void {
		$result = new Industry_Page_Template_Recommendation_Result( array(
			array( 'page_template_key' => 't_weak', 'score' => 5, 'fit_classification' => 'allowed_weak_fit', 'explanation_reasons' => array(), 'industry_source_refs' => array(), 'hierarchy_fit' => '', 'lpagery_fit' => '', 'warning_flags' => array() ),
		) );
	...
	public function test_template_substitutes_returns_ordered_by_family_then_score(): void {
		$items = array(
			array( 'page_template_key' => 't_weak', 'score' => 5, 'fit_classification' => 'allowed_weak_fit', 'explanation_reasons' => array(), 'industry_source_refs' => array(), 'hierarchy_fit' => '', 'lpagery_fit' => '', 'warning_flags' => array() ),
			array( 'page_template_key' => 't_rec_same', 'score' => 35, 'fit_classification' => 'recommended', 'explanation_reasons' => array(), 'industry_source_refs' => array(), 'hierarchy_fit' => '', 'lpagery_fit' => '', 'warning_flags' => array() ),
			array( 'page_template_key' => 't_rec_other', 'score' => 40, 'fit_classification' => 'recommended', 'explanation_reasons' => array(), 'industry_source_refs' => array(), 'hierarchy_fit' => '', 'lpagery_fit' => '', 'warning_flags' => array() ),
		);
		$result = new Industry_Page_Template_Recommendation_Result( $items );
		$defs = array(
			array( 'internal_key' => 't_weak', 'template_family' => 'landing' ),
			array( 'internal_key' => 't_rec_same', 'template_family' => 'landing' ),
			array( 'internal_key' => 't_rec_other', 'template_family' => 'hub' ),
		);
