...
final class Duplicate_Detector_Test extends TestCase {
	...
	public function test_find_duplicate_returns_null_when_empty_known_pages(): void {
		...
		$candidate = array( 'normalized_url' => 'https://example.com/page', 'canonical_url' => 'https://example.com/page' );
	...
	public function test_find_duplicate_returns_null_when_no_match(): void {
		...
		$known = array(
			array( 'normalized_url' => 'https://example.com/one', 'canonical_url' => 'https://example.com/one', 'content_hash' => 'bbb' ),
		);
	...
	public function test_find_duplicate_returns_canonical_match(): void {
		...
		$known = array(
			array( 'normalized_url' => 'https://example.com/canonical-page', 'canonical_url' => $canon ),
		);
