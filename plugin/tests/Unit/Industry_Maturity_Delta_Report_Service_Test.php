...
final class Industry_Maturity_Delta_Report_Service_Test extends TestCase {
	...
	public function test_generate_report_with_baseline_returns_trends(): void {
		...
		$baseline = array(
			'families' => array(
				'realtor' => array( 'band' => Industry_Pack_Completeness_Report_Service::BAND_MINIMAL_VIABLE, 'total' => 5 ),
			),
	...
	public function test_trend_improvement_when_band_increases(): void {
		...
		$baseline = array(
			'families' => array(
				'test_pack' => array( 'band' => Industry_Pack_Completeness_Report_Service::BAND_BELOW_MINIMAL, 'total' => 2 ),
			),
			'capability_areas' => array(),
			'captured_at'      => '2020-01-01T00:00:00Z',
		);
