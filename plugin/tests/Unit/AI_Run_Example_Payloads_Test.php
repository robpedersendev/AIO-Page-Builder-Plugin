...
final class AI_Run_Example_Payloads_Test extends TestCase {
	...
	public const EXAMPLE_ARTIFACT_SUMMARY = array(
		Artifact_Category_Keys::RAW_PROMPT              => array( 'present' => true,  'summary' => '[redacted]', 'redacted' => true ),
		Artifact_Category_Keys::NORMALIZED_PROMPT_PACKAGE => array( 'present' => true,  'summary' => '[redacted]', 'redacted' => true ),
		Artifact_Category_Keys::INPUT_SNAPSHOT          => array( 'present' => true,  'summary' => '[redacted]', 'redacted' => true ),
		Artifact_Category_Keys::FILE_MANIFEST            => array( 'present' => false, 'summary' => '',         'redacted' => false ),
		Artifact_Category_Keys::RAW_PROVIDER_RESPONSE    => array( 'present' => true,  'summary' => '[redacted]', 'redacted' => true ),
		Artifact_Category_Keys::NORMALIZED_OUTPUT        => array( 'present' => true,  'summary' => array( 'keys' => array( 'pages' ), 'count' => 1 ), 'redacted' => false ),
		Artifact_Category_Keys::VALIDATION_REPORT       => array( 'present' => true,  'summary' => array( 'keys' => array( 'valid', 'errors' ), 'count' => 2 ), 'redacted' => false ),
		Artifact_Category_Keys::DROPPED_RECORD_REPORT   => array( 'present' => false, 'summary' => '',         'redacted' => false ),
		Artifact_Category_Keys::RETRY_METADATA          => array( 'present' => false, 'summary' => '',         'redacted' => false ),
		Artifact_Category_Keys::USAGE_METADATA           => array( 'present' => true,  'summary' => array( 'keys' => array( 'input_tokens', 'output_tokens' ), 'count' => 2 ), 'redacted' => false ),
		Artifact_Category_Keys::BUILD_PLAN_REF           => array( 'present' => false, 'summary' => '',         'redacted' => false ),
	);
