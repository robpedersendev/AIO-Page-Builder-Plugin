<?php
/**
 * Unit tests for Industry_Page_Template_Preview_Resolver (Prompt 383).
 *
...
use AIOPageBuilder\Domain\Industry\Registry\Industry_Page_Template_Preview_Resolver;
...
final class Industry_Page_Template_Preview_Resolver_Test extends TestCase {
