...
final class Industry_Subtype_Page_Template_Recommendation_Extender_Test extends TestCase {
	...
	public function test_apply_subtype_influence_null_subtype_returns_result_with_subtype_fields_false(): void {
		$base     = new Industry_Page_Template_Recommendation_Result(
			array(
				array(
					'page_template_key'    => 'service_01',
					'score'                => 10,
	...
	public function test_apply_subtype_influence_page_family_emphasis_boosts_matching_templates(): void {
		$base      = new Industry_Page_Template_Recommendation_Result(
			array(
				array(
					'page_template_key'    => 'service_01',
					'score'                => 15,
					'fit_classification'   => Industry_Page_Template_Recommendation_Resolver::FIT_ALLOWED_WEAK,
					'explanation_reasons'  => array(),
					'industry_source_refs' => array(),
					'hierarchy_fit'        => '',
					'lpagery_fit'          => '',
		...
		$templates = array(
			array(
				Page_Template_Schema::FIELD_INTERNAL_KEY => 'service_01',
				'template_family'                        => 'service',
			),
			array(
				Page_Template_Schema::FIELD_INTERNAL_KEY => 'landing_01',
